...
import com.example.demo.datalayer.Employee;
import com.example.demo.datalayer.EmployeeModelAssembler;
import com.example.demo.datalayer.EmployeeNotFoundException;
import com.example.demo.datalayer.EmployeeRepository;
...
public class EmployeeController {
    ...
    public CollectionModel<EntityModel<Employee>> all() {
       ...
       //         .collect(Collectors.toList());  **replaced by the following:
    ...
    public EntityModel<Employee> one(@PathVariable Long id){
       ...
       // linkTo(methodOn(EmployeeController.class).all()).withRel("employees")); **replaced by the following:
